        ...
        <div v-for="(info, index) in customerInfos" :key="index" :class="['customer-info', { 'active': currentIndex === index }]">
          ...
          <div class="customer-details">
            <div class="external-links">
                <div class="linkovi">
            <a href="https://www.myjobquote.co.uk/t/light-supply-electrical-services" target="_blank" class="e-link"><font-awesome-icon class="icon" :icon="['fas', 'arrow-up-right-from-square']" />Click to see more on MyJobQuote <span>51</span>reviews </a> 
